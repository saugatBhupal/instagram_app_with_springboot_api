...
import 'package:instagram/src/core/utils/app_constants.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      vsync: this,
      duration: const Duration(microseconds: AppConstants.animationTime),
    );
    _animation = Tween(begin: 0.0, end: 1.0).animate(_animationController);

    _animationController.forward();
    _timer = Timer(const Duration(milliseconds: AppConstants.navigateTime),
